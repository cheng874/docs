...
# Evaluation Results
## Benchmark Result
| Metrics      | HY-MT2-7B-Nvidia-Origin | HY-MT2-7B-Metax-FlagOS |
|--------------|--------------------------------|------------------------|
| flores_ca     | 52.46                   | 52.4576                |
| wmt16         | 60.21                   | 60.1966              |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-7b-metax-tree_none-gems_4.2.0-vllm_0.13.0_empty-plugin_0.0.0-cx_0.8.0-python_3.12.11-torch_2.8.0_metax3.3.0.2-pcp_maca3.3.0.15-gpu_metax001-arc_amd64-driver_3.8.1:202605280644
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/HY-MT2-7B-metax-FlagOS --local_dir /data/HY-MT2-7B
```
...
docker run -itd \
    ...
    --privileged \
     ...
     -v /data/:/data/ \
     harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-7b-metax-tree_none-gems_4.2.0-vllm_0.13.0_empty-plugin_0.0.0-cx_0.8.0-python_3.12.11-torch_2.8.0_metax3.3.0.2-pcp_maca3.3.0.15-gpu_metax001-arc_amd64-driver_3.8.1:202605280644
     /bin/bash
