...
# Evaluation Results
## Benchmark Result
| Metrics      | Xing4.0-29B-A4B-Nvidia-Origin | Xing4.0-29B-A4B-T-Head-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA_Diamond | 62.63 | 61.62  |
| Math-500        | 84.80 | 83.40  |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/xing4_0-pp001-gems5.3.5-tree0.6.2-cxnone-plugin0.0.0-vllm0.24.0-cp312-pt210-hggc130-x64-2.1.1-rbd225:202609211738
...
modelscope download --model FlagRelease/Xing4.0-29B-A4B-BF16-zhenwu-FlagOS --local_dir /data/Xing4.0-29B-A4B
```
...
docker run --privileged -dit \
  ...
  -v /data:/data \
  --name xing4.0-flagos \
  harbor.baai.ac.cn/flagrelease-public/xing4_0-pp001-gems5.3.5-tree0.6.2-cxnone-plugin0.0.0-vllm0.24.0-cp312-pt210-hggc130-x64-2.1.1-rbd225:202609211738
```
### Start the Server
```bash
