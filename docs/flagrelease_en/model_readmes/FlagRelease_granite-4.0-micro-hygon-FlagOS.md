...
```bash
docker pull harbor.baai.ac.cn/flagrelease-project/granite-4.0-micro-hygon001-gems5.4.0-tree0.6.0-cxnone-plugin0.0.0-vllm0.20.2-cp310-pt210-dtknone-x64-6.3.28-v1.3.0b:202607171543-v5
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/granite-4.0-micro-hygon-FlagOS --local_dir /data/granite-4.0-micro-FlagOS
```

### Start the Container
```bash
docker run -d --name flagos --net=host --ipc=host --device=/dev/kfd --device=/dev/mkfd --device=/dev/dri --group-add video -v /opt/hyhal:/opt/hyhal -v /data:/data -v /data:/data harbor.baai.ac.cn/flagrelease-project/granite-4.0-micro-hygon001-gems5.4.0-tree0.6.0-cxnone-plugin0.0.0-vllm0.20.2-cp310-pt210-dtknone-x64-6.3.28-v1.3.0b:202607171543-v5 sleep infinity
```
### Start the Server
```bash
vllm serve /data/granite-4.0-micro-FlagOS --host 0.0.0.0 --port 8000 --served-model-name granite-4.0-micro --trust-remote-code --max-model-len 4096 --tensor-parallel-size 4
```
...
# License
The model weights are derived from AI-ModelScope/granite-4.0-micro and are open‑sourced under the Apache License 2.0: https://www.apache.org/licenses/LICENSE-2.0.txt
