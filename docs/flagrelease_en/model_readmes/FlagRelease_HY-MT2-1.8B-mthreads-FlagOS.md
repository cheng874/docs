...
# Evaluation Results
## Benchmark Result
| Metrics(chrf) | HY-MT2-1.8B-Nvidia-Origin | HY-MT2-1.8B-Mthreads-FlagOS |
|---------------|--------------------------------|-----------------------------|
| flores_ca     | 45.32                     | 45.3902                     |
| wmt16         | 57.2                      | 57.2343                     |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-1.8b-mthreads-tree_0.5.1_mthreads3.6-gems_5.0.2-vllm_0.13.1.dev44_g3d4cc4bc7.d20260310.musa-plugin_0.1.0-cx_0.8.0-python_3.10.12-torch_2.7.1-pcp_musa4.3.5-driver_3.3.6:202605281243
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/HY-MT2-1.8B-mthreads-FlagOS --local_dir /data/HY-MT2-1.8B
```
...
docker run -d \
    ...
    harbor.baai.ac.cn/flagrelease-public/flagrelease-hy-mt2-1.8b-mthreads-tree_0.5.1_mthreads3.6-gems_5.0.2-vllm_0.13.1.dev44_g3d4cc4bc7.d20260310.musa-plugin_0.1.0-cx_0.8.0-python_3.10.12-torch_2.7.1-pcp_musa4.3.5-driver_3.3.6:202605281243 \
    bash
