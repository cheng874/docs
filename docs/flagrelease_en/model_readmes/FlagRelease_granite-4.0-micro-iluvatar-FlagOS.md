...
### Start the Server
```bash
VLLM_PLUGINS=fl vllm serve /data/granite-4.0-micro-FlagOS --host 0.0.0.0 --port 8000 --served-model-name granite-4.0-micro --tensor-parallel-size 1 --max-model-len 32768 --trust-remote-code --enforce-eager
```
