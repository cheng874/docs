...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-1B-Nvidia-Origin | MiniCPM5-1B-Hygon-FlagOS |
|--------------|--------------------------------------|--------------------------------------|
| hellaswag | 0.4742 | 0.4628 |
| truthfulqa_mc1 | 0.3293 | 0.3354 |
| winogrande | 0.5484 | 0.5406 |
| commonsense_qa | 0.3473 | 0.3522 |
...
modelscope download --model FlagRelease/MiniCPM5-1B-hygon-FlagOS --local_dir /data/MiniCPM5-1B
```
