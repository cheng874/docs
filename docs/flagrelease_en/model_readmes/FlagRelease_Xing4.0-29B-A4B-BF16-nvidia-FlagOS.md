...
# Evaluation Results
## Benchmark Result
| Metrics      | Xing4.0-29B-A4B-Nvidia-Origin | Xing4.0-29B-A4B-Nvidia-FlagOS |
|--------------|--------------------------------|--------------------------------------|
| GPQA_Diamond | 62.63 | 69.70  |
| Math-500        | 84.80 | 83.80  |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/xing4_0-nvidia003-gems5.4.0-tree0.6.2-cxnone-plugin0.0.0-vllm0.24.0-cp312-pt211-cu129-x64-580.105.08:202609211737
...
modelscope download --model FlagRelease/Xing4.0-29B-A4B-BF16-nvidia-FlagOS --local_dir /data/Xing4.0-29B-A4B
```
...
docker run -dit \
  ...
  harbor.baai.ac.cn/flagrelease-public/xing4_0-nvidia003-gems5.4.0-tree0.6.2-cxnone-plugin0.0.0-vllm0.24.0-cp312-pt211-cu129-x64-580.105.08:202609211737

```
### Start the Server
```bash
VLLM_FL_USE_FLAGGEMS_ATTN=1 vllm serve /data/Xing4.0-29B-A4B \
  --served-model-name xing4.0-flagos \
  --host 0.0.0.0 \
  --port 8000 \
  --dtype bfloat16 \
