...
# Evaluation Results
## Benchmark Result
| Metrics      | MiniCPM5-1B-Nvidia-Origin | MiniCPM5-1B-Nvidia-FlagOS |
|--------------|--------------------------------------|--------------------------------------|
| hellaswag | 0.4742 | 0.475 |
| truthfulqa_mc1 | 0.3293 | 0.3293 |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-nvidia-tree_0.4.0_3.5-gems_4.2.1rc0-vllm_0.16.0rc2.dev221_ga5ccc85c8-plugin_none-cx_none-python_3.12.3-torch_2.10.0-pcp_cuda13.1-gpu_nvidia003-arc_amd64-driver_570.158.01:202605211607
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/MiniCPM5-1B-nvidia-FlagOS --local_dir /data/MiniCPM5-1B
```
...
sudo docker run --init --detach --net=host --user 0 --ipc=host \
           ...
           --name flagos harbor.baai.ac.cn/flagrelease-public/flagrelease-minicpm5-nvidia-tree_0.4.0_3.5-gems_4.2.1rc0-vllm_0.16.0rc2.dev221_ga5ccc85c8-plugin_none-cx_none-python_3.12.3-torch_2.10.0-pcp_cuda13.1-gpu_nvidia003-arc_amd64-driver_570.158.01:202605211607 sleep infinity
