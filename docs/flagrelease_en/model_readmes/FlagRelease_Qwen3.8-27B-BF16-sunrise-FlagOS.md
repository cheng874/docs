...
# Evaluation Results
## Benchmark Result
| Metrics | Qwen3.8-27B-Nvidia-Origin | Qwen3.8-27B-sunrise-FlagOS |
|--------------|--------------------------|--------------------------------------|
| musr_murder_mysteries| 76.8                      | 75.61                      |
| GPQA_Diamond | 90.4                      | 87.75                      |
...
```bash
docker pull harbor.baai.ac.cn/flagrelease-public/flagos-container-ubuntu2404-base-build-sunrise-gems5.0.2-treenone-cx0.13.0-pluginnone-vllmnone-cp310-pt29-pt-x64-0.25.0-server:202608151140
```

### Download Open-source Model Weights
```bash
pip install modelscope
modelscope download --model FlagRelease/Qwen3.8-27B-BF16-sunrise-FlagOS --local_dir /data/Qwen3.8-27B
```

### Start the Container
```bash
docker run -d --privileged --network host --name "flagos-container-ubuntu2404-base-build" \
  -v /home/flagos/code/models/:/code/models \
  -v /usr/local/tangrt:/usr/local/tangrt \
  -v /usr/local/pccl:/usr/local/pccl \
  harbor.baai.ac.cn/flagrelease-public/flagos-container-ubuntu2404-base-build-sunrise-gems5.0.2-treenone-cx0.13.0-pluginnone-vllmnone-cp310-pt29-pt-x64-0.25.0-server:202608151140 /bin/bash -c "tail -f /dev/null"
```
### Start the Server
```bash
...
nohup vllm serve /data/Qwen3.8-27B \
...
### Invocation Script
```bash
curl http://127.0.0.1:7528/v1/chat/completions \
