...
```{note}
这是 FlagOS 2.2 的候选发布版（标签 `v2.1.0-rc2.post1`，发布于 2026-09；取代 `v2.1.0-rc1.post1` 与 `v2.1.0-rc0.post1`）。版本号与支持平台列表将在 GA 时最终确定。
```
...
FlagScale v2.1.0-rc2 已与 Megatron-LM-FL v0.3.0-rc2、TransformerEngine-FL v0.3.0-rc2 一起，在四类非 NVIDIA 平台上完成端到端验证：
