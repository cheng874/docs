[[英文版](./install_mthreads.md)|中文版]

## 💫 摩尔线程（Moore Threads）[mthreads](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/third_party/mthreads/)（Triton 3.6）
...
参考 [MThreads 3.6 后端测试](https://github.com/flagos-ai/FlagTree/tree/triton_v3.6.x/.github/workflows/mthreads-build-and-test.yml)

## 💫 摩尔线程（Moore Threads）[mthreads](https://github.com/flagos-ai/FlagTree/tree/triton_v3.2.x/third_party/mthreads/)（Triton 3.2）
...
参考 [MThreads 3.2 后端测试](https://github.com/flagos-ai/FlagTree/tree/triton_v3.2.x/.github/workflows/mthreads-build-and-test.yml)

## 💫 摩尔线程（Moore Threads）[mthreads](https://github.com/flagos-ai/FlagTree/tree/main/third_party/mthreads/)（Triton 3.1）
...
参考 [MThreads 3.1 后端测试](/.github/workflows/mthreads-build-and-test.yml)

对于使用 `tl.dot` 的 Triton 3.1 内核，设置环境变量 `export MUSA_ENABLE_SQMMA=1` 可以提升性能。
