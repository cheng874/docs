...
See [installation](..//install) for some detailed guidance
...
If you are using a [non-NVIDIA platform](../usage/non-nvidia),
...
Note that if you are using a [non-NVIDIA platform](../usage/non-nvidia),
...
Check the [using FlagGems](./usage) section for more detailed
